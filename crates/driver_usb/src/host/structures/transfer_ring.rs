...
impl TransferRing {
    ...
    pub fn new() -> Self {
        super::registers::handle(|r| {
            ...
            let get_trb_count = transfer_ring.get_trb_count();
            let ringsize = transfer_ring.ring.virt_addr().as_usize() as u64;
            let mut link_trb = &mut transfer_ring.ring[get_trb_count - 1];
