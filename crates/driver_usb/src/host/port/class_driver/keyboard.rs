...
use {
    crate::{
        host::port::init::fully_operational::FullyOperational,
        host::structures::descriptor::{Configuration, Descriptor},
    },
...
pub(in crate::host::port) async fn task(eps: FullyOperational) {
...
impl Keyboard {
    pub(in crate::host::port) fn new(ep: FullyOperational) -> Self {
        Self {
            ep,
            buf: [0; 8].into(),
        }
