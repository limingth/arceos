...
use super::{MemoryMapper, XhciBehaviors};
...
pub struct CommandRing {
    ...
    enq_p: usize,
    cycle_bit: bool,
    reg: Arc<Spinlock<&'static mut dyn XhciBehaviors>>,
}

// 实现CommandRing结构体的方法
impl CommandRing {
    // 创建一个新的命令环
    pub fn new(reg: Arc<Spinlock<&'static mut dyn XhciBehaviors>>) -> Self {
    ...
    fn notify_command_is_sent(&mut self) {
        self.reg.lock().regs().doorbell.update_volatile_at(0, |r| {
